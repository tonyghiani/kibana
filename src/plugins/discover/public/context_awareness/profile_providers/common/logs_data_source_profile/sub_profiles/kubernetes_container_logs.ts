...
import { createGetDefaultAppState } from '../../../observability/logs_data_source_profile/accessors';
import {
  LOG_LEVEL_COLUMN,
  MESSAGE_COLUMN,
} from '../../../observability/logs_data_source_profile/consts';
...
export const createKubernetesContainerLogsDataSourceProfileProvider = (
  ...
  extendProfileProvider(logsDataSourceProfileProvider, {
    profileId: 'classic-kubernetes-container-logs-data-source-profile',
    profile: {
